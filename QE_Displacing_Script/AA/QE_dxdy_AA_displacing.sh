...
ATOMIC_POSITIONS alat
     ...
     C    `echo "scale=2; 1.4202810389+$dx" | bc -l`    `echo "scale=2; 0.0000000000+$dy" | bc -l`    7.625000000
...
Begin Atoms_Cart
     ...
     C3    `echo "scale=2; 1.4202810389+$dx" | bc -l`    `echo "scale=2; 0.0000000000+$dy" | bc -l`    7.625000000
